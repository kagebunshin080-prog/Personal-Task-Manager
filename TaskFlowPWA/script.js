...
// ---------- Google Sign-In ----------
// Runs once the Google Identity Services script (loaded in index.html) is ready.
...
// The GSI script loads with `defer`, so it may not be ready the instant this
// file runs. Poll briefly until window.google exists, then initialize.
